...
import { abi as AVE_ABI } from '@uniswap/governance/build/Uni.json'
import { abi as STAKING_REWARDS_ABI } from '@uniswap/liquidity-staker/build/StakingRewards.json'
import { abi as MERKLE_DISTRIBUTOR_ABI } from '@uniswap/merkle-distributor/build/MerkleDistributor.json'
import { abi as IAveswapV2PairABI } from '@uniswap/v2-core/build/IUniswapV2Pair.json'
...
import { abi as IAveswapV2Router02ABI } from '@uniswap/v2-periphery/build/IUniswapV2Router02.json'
...
import { AVE, WETH9_EXTENDED } from '../constants/tokens'
...
export function usePairContract(pairAddress?: string, withSignerIfPossible?: boolean): Contract | null {
  return useContract(pairAddress, IAveswapV2PairABI, withSignerIfPossible)
}

export function useV2RouterContract(): Contract | null {
  return useContract(V2_ROUTER_ADDRESS, IAveswapV2Router02ABI, true)
}
...
export function useUniContract() {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId ? AVE[chainId]?.address : undefined, AVE_ABI, true)
}
