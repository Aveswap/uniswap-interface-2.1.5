      ...
      <BodyWrapper style={{ padding: 24 }}>
        <AutoColumn gap="16px">
          <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
            ...
            <div>
              <QuestionHelper text={<Trans>Migrate your liquidity tokens from Aveswap V2 to Aveswap V3.</Trans>} />
            </div>
          </AutoRow>

          <TYPE.body style={{ marginBottom: 8, fontWeight: 400 }}>
            <Trans>
              For each pool shown below, click migrate to remove your liquidity from Aveswap V2 and deposit it into
              Aveswap V3.
            </Trans>
          </TYPE.body>
