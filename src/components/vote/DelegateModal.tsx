...
export default function DelegateModal({ isOpen, onDismiss, title }: VoteModalProps) {
  ...
  const uniBalance = useTokenBalance(account ?? undefined, chainId ? AVE[chainId] : undefined)
      ...
      {!attempting && !hash && (
        <ContentWrapper gap="lg">
          <AutoColumn gap="lg" justify="center">
            ...
            <TYPE.body>
              <Trans>Earned AVE tokens represent voting shares in Uniswap governance.</Trans>
            </TYPE.body>
            <TYPE.body>
